  ...
  stages {
    ...
    stage('Checkout branch') {
      steps {
        ...
        checkout([$class: 'GitSCM', branches: [[name: '*/main/pr']], extensions: [], userRemoteConfigs: [[credentialsId: 'Project1TestPoll-2', url: 'https://github.com/jamesguise/publicTest.git']]])
